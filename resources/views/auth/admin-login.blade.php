    ...
    <body>
        ...
        <div class="padding-15">
            ...
            <div class="login-box">
                ...
                <!-- login form -->
                <form role="form" method="POST" action="{{ route('admin.login.submit') }}" class="sky-form boxed">
                {{ csrf_field() }}
                    ...
                    <fieldset>  
                        ...
                        <section>
                            ...
                            <label class="checkbox"><input type="checkbox" name="remember" {{ old('remember') ? 'checked' : ''}} ><i></i>Se rappeler de moi</label>
                        </section>
