 ...
 @section('content')
   ...
   <section id="middle">
       ...
       <header id="page-header">
         <h1>Générer certificat</h1>
         <ol class="breadcrumb">
           <li><a href="/admin">Accueil</a></li>
           <li class="active">Générer certificats</li>
         </ol>
       </header>
       <!-- /page title -->
       ...
       <div id="content" class="padding-20">
         ...
         <div align="center" style="margin-bottom: 20px">
           ...
           <div class="panel-body">
             {!! Form::open(['method' => 'GET', 'url' => route('certificats.download'), 'class' => 'form', 'id' =>'form']) !!}
            ...
            <div align="center" style="margin-top: 20px; margin-bottom: -20px">
              <button type="submit" name="Enregistrer" class="btn btn-yellow"><i class="fa fa-download"></i>Télécharger les certificats</button>
            </div>
