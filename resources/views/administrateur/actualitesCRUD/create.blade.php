				...
				<div id="content" class="dashboard padding-20">
                    ...
                    <div class="panel panel-default">
						...
						<div class="panel-body">
							...
							{!! Form::open(array('route' => 'actualites.store','method'=>'POST','files'=>true,'class' => 'validate')) !!}
							<table class="table table-striped table-bordered table-hover">
								...
								<tr>
									<td>
									<input type="textarea" class="form-control required richtext" placeholder="Votre objectif..." name="description_actualite" style="height: 250px" />
									</td>
								</tr>
								<tr>
									<td align="Center">
