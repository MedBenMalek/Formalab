		...
		<section id="middle">
				...
				<div id="content" class="padding-20">
					...
					<div id="panel-1" class="panel panel-default">
						...
						<a href="{{ route('actualites.create') }}" class="btn btn-yellow"><i class="fa fa-plus white" ></i> Ajouter Actualité  </a>
									...
									@foreach($actualites as $actualite)
										<tr >
											...
											<!--<a href="#" class="btn btn-default btn-xs"><i class="fa fa-eye white"></i> Consulter </a-->
												...
												{!! Form::open(['method' => 'POST','route' => ['actualites.archiver', $actualite->id_actualite] ,'style'=>'display:inline']) !!}
