                ...
                <section class="panel">
                  <div class="panel-body noradius padding-10">
                    ...
                    <figure class="margin-bottom-10" align="center"><!-- image -->
                      <img class="img-responsive" src="{{url('adm/assets/images/admin/'.Auth::user()->image)}}" alt="" />
                    </figure><!-- /image -->
                    {!! Form::model($admin, ['method' => 'POST','files'=>true,'route' => ['admin.profile.imgedit', Auth::user()->id], 'class' => 'form-horizontal']) !!}
                  ...
                  {!! Form::close() !!}
									<div class="toggle active">
										...
										<div class="toggle-content">
											{!! Form::model($admin, ['method' => 'POST','files'=>true,'route' => ['admin.profile.reseaux', Auth::user()->id], 'class' => 'form-horizontal']) !!}
											<fieldset>
                ...
                <div class="tabs white nomargin-top">
                  <div class="tab-content">
                      ...
                      <div class="toggle active">
                        ...
                        <div class="toggle-content">
                          {!! Form::model($admin, ['method' => 'POST','files'=>true,'route' => ['admin.profile.edit', Auth::user()->id], 'class' => 'form-horizontal']) !!}
                          <fieldset>
                            <div class="form-group">
                        ...
                        <div class="toggle-content">
                          {!! Form::model($admin, ['method' => 'POST','files'=>true,'route' => ['admin.profile.emailedit', Auth::user()->id], 'class' => 'form-horizontal']) !!}
                          <fieldset>
                            <div class="form-group">
                        ...
                        <div class="toggle-content">
                          {!! Form::model($admin, ['method' => 'POST','files'=>true,'route' => ['admin.profile.pwdedit', Auth::user()->id], 'class' => 'form-horizontal']) !!}
                          <fieldset>
                            <div class="form-group">
                              <label class="col-md-3 control-label" for="profileFirstName">Ancien mot de passe :</label>
                              <div class="col-md-8">
